...
export class HomeComponent implements OnInit {
  ...
  private readonly getTiposHabitacionUseCase = inject(
    GetTiposHabitacionUseCase,
  );
  private readonly setReservaUseCase: SetReservaUseCase =
    inject(SetReservaUseCase);
  ...
  formValido(): boolean {
    return (
      this.dateIn !== "" && this.dateOut !== "" && this.tipoSeleccionado > 0
    );
  }
